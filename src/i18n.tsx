                ...
                translation: {
                    ...
                    pages: {
                        ...
                        admin: {
                            ...
                            hour: 'час',
                            address: 'Адрес',
                            provideYourDeliveryAddress: 'Укажите ваш адрес для доставки',
                            street: 'Улица',
                            placeholderStreet: 'Пушкина',
                            house: 'Дом',
                            placeholderHouse: '12',
                            apartment: 'Квартира',
                            placeholderApartment: '32',
                            placeholderAddress: 'Заезд с парковки ...',
                            nameLabelAddress: 'Коментарий',
                            nameLabelDetails: '(необязательное поле)',
                            inBasket: 'В корзину',
                            createOrderForPayment: 'Создать заказ: к оплате',
