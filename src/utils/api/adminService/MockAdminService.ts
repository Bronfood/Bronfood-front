...
import cake from './MockData/cake.jpg';
import { AdminBasket } from './adminService';
...
export const meals: CateringMeal[] = [
        ...
        features: [
            {
                ...
                choices: [
                    ...
                    { id: 3, name: 'огурчики', price: 40, is_visible: true, is_default: false },
                ],
            },
            {
                id: 2,
                ...
                pricing_strategy: 'add',
                choices: [
                    { id: 4, name: '25 см', price: 50, is_visible: true, is_default: true },
                    { id: 5, name: '35 см', price: 100, is_visible: true, is_default: false },
                ],
            },
        ],
    },
    {
        id: 2,
        name: 'Латте',
        description: 'Латте на кококосовом с пенкой.',
        photo: latte,
        base_price: 200,
        waiting_time: '00:00:00',
        ...
        features: [
            {
                ...
                pricing_strategy: 'add',
                choices: [
                    { id: 6, name: '300 мл', price: 50, is_visible: true, is_default: true },
                    { id: 7, name: '500 мл', price: 70, is_visible: true, is_default: false },
                ],
            },
        ],
    },
...
export const basket: AdminBasket = {
    meals: [
        {
            id: 1,
            name: 'Куриный донер',
